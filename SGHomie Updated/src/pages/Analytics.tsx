...
const Analytics = () => {
  ...
  // Comprehensive static data matching the API structure
  const staticData = [
  ...
  // Process data for town comparison
                        ...
                        {towns.map(town => (
                          <button
                            ...
                            className={`block w-full text-left px-4 py-2 hover:bg-gray-100 rounded ${
                              selectedTowns.includes(town) ? 'bg-blue-50' : ''
                            }`}
